...
import static com.example.dutch.Activity.MainActivity.findAddressbtn;
...
import static com.example.dutch.ArraySavingClass.array_saving_class.final_location_size;
import static com.example.dutch.ArraySavingClass.array_saving_class.nameOfIt;
import static com.example.dutch.ArraySavingClass.array_saving_class.overLap;
...
public class AddressMarkActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		Dutch_Mark.markReturn(markerImage, tMapView, alTMapPoint, nameOfIt, buttonNum, btnClickSize, buttonNumArr); // 검색한 위치에 마커를 뜨게 하는 메소드
		...
		name_textView.setText(array_saving_class.nameOfIt[buttonNum]); // 프레임 레이아웃의 주소텍스트를 검색한 위치의 주소로 설정
		...
		yesBtn.setOnClickListener(new Button.OnClickListener() {
			...
			public void onClick(View view) {
				...
				array_saving_class.final_Point[buttonNum]= (new TMapPoint(alTMapPoint[buttonNum].getLongitude(), alTMapPoint[buttonNum].getLatitude()));
