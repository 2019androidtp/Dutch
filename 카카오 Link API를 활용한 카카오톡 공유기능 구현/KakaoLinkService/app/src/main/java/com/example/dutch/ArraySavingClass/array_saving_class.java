package com.example.dutch.ArraySavingClass;
...
public class array_saving_class {
      ...
      public static String[] infraList = new String[10]; // 주변시설을 검색해서 나오는 장소의 이름들을 저장해주는 String 배열
      public static String[] infraAddress = new String[10]; // 주변시설을 검색해서 나오는 장소의 주소들을 저장해주는 String 배열
      public static TMapPoint[] infraTMapPoint =  new TMapPoint[10]; // 주변시설을 검색해서 나오는 장소의 좌표들을 저장해주는 TMapPoint 배열
      public static double[] infraLat = new double[11]; // 주변시설을 검색해서 나오는 장소의 좌표의 위도값을 저장해주는 double 배열
      public static double[] infraLon = new double[11]; // 주변시설을 검색해서 나오는 장소의 좌표의 경도값을 저장해주는 double 배열
